                ...
                <ul>
                  <li v-for="(one,index2) in oneList.foods" :key2="index2" @click="showOneFoodInfo(index1,index2)">
                    ...
                    <div class="info_right">
                      ...
                      <div class="row_act">
                        <p>
                        <span v-if="one.specfoods[0].activity">{{getDiscount(one.specfoods[0].original_price,one.specfoods[0].price)}}折</span>
                      ...
                      <div class="row4">
                        ...
                        <div class="row4_right">
                          <CartBar :food="foodShopInfo.menu[index1].foods[index2]" ></CartBar>
                        </div>
                      </div>
                    </div>
                  </li>
...
<style scoped>
  ...
  .main_left h3 del,.row4_left del{
    font-size: .75rem;
    color: #999;
    font-weight: lighter;
    margin-left: 3px;
